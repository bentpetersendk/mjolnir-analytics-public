...
assert "queueInsights" in app and "buildPlatformRegistry({ data, nodeInsights, nodeInsightsHistory, slurmAnalyticsPipeline, queueInsights, softwareInventory, softwareIntelligence })" in app, \
    "Queue Insights/Software Inventory/Software Intelligence must be registered in buildPlatformRegistry, not left planned"
